        ...
        <div className="col-lg-6 mb-4 ">
            <div className="card shadow mb-4 ">
                ...
                <div className="card-body">
                    ...
                    <a className="btn btn-danger margin" target="_blank" rel='noopener noreferrer' href={lastProduct && lastProduct.url}>Ver detalle del producto</a>
                    <a className="btn btn-danger margin" target="_blank" rel='noopener noreferrer' href={lastProduct && `http://localhost:3001/productos/detalle/${lastProduct.id}`}>Ver en la Web</a>
                </div>
            </div>
        </div>
    )
